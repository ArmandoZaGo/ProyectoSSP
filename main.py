...
class Registro():
	def __init__(self):
		...
		self.NombreE = Entry(self.FrameR, font=("Times New Roman",14)).place(width=300,height=30,x=105,y=200)
		self.Apellido = Label(self.FrameR, text="Apellido:", font=("Times New Roman",18)).place(x=100,y=240)
		self.ApellidoE = Entry(self.FrameR, font=("Times New Roman",14)).place(width=300,height=30,x=105,y=280)
		self.Edad = Label(self.FrameR, text="Edad:", font=("Times New Roman",18)).place(x=100,y=320)
		self.EdadE = Entry(self.FrameR, font=("Times New Roman",14)).place(width=300,height=30,x=105,y=360)
		self.Sexo = Label(self.FrameR, text="Sexo:", font=("Times New Roman",18)).place(x=100,y=400)
		self.SexoE = Entry(self.FrameR, font=("Times New Roman",14)).place(width=300,height=30,x=105,y=440)
		self.Carrera = Label(self.FrameR, text="Carrera:", font=("Times New Roman",18)).place(x=500,y=160)
		self.CarreraE = Entry(self.FrameR, font=("Times New Roman",14)).place(width=300,height=30,x=505,y=200)
		self.Division = Label(self.FrameR, text="Division UG:", font=("Times New Roman",18)).place(x=500,y=240)
		self.DivsionE = Entry(self.FrameR, font=("Times New Roman",14)).place(width=300,height=30,x=505,y=280)
		self.Correo = Label(self.FrameR, text="Correo:", font=("Times New Roman",18)).place(x=500,y=320)
		self.CorreoE = Entry(self.FrameR, font=("Times New Roman",14)).place(width=300,height=30,x=505,y=360)
		self.Password = Label(self.FrameR, text="Contraseña:", font=("Times New Roman",18)).place(x=500,y=400)
		self.PasswordE = Entry(self.FrameR, font=("Times New Roman",14)).place(width=300,height=30,x=505,y=440)
		self.BReg = Button(self.FrameR,text="Regresar",command=self.OpIni,font=("Times New Roman",15)).place(x=500,y=500)
		self.BEnv = Button(self.FrameR,text="Enviar",font=("Times New Roman",15)).place(x=600,y=500)
		self.Raiz.mainloop()
